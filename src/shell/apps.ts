...
export type AppId = 'overview' | 'stake' | 'bond' | 'treasury' | 'calculator' | 'buy' | 'prospectus' | 'paperhands'
...
export const APPS: AppDef[] = [
  ...
  { id: 'bond', title: 'Bond Desk', short: 'Bond Desk', blurb: 'MOASS at a discount, vested', icon: '🏦', tint: '#f8b636', w: 720, h: 540, component: lazy(() => import('../apps/BondDesk')) },
  { id: 'treasury', title: 'My Treasury', short: 'My Treasury', blurb: 'The 3x GME long, live', icon: '🗄️', tint: '#3a6ea5', w: 800, h: 580, component: lazy(() => import('../apps/Treasury')) },
  ...
  { id: 'buy', title: 'Buy $MOASS - Internet Exploder', short: 'Buy $MOASS', blurb: 'Swap GME for MOASS', icon: '🌐', tint: '#1e90ff', w: 640, h: 500, component: lazy(() => import('../apps/Buy')) },
